...
<body style="box-shadow:noneimoprtant;" class="grey lighten-3 text-font">
  ...
  <div class="d-flex " id="wrapper">
    ...
    <!-- Sidebar -->
     <div class="sidebar-fixed position-fixed " id="sidebar-wrapper" style="box-shadow:none!important;background:#181818;">
      <div class="sidebar-heading white-text my-3" >
          <a href="{{route('super-admin.index')}}" style="color:yellow"><h6 class="h4 h4-responsive">Super Admin Management</h6></a>
      </div> 
      <div class="list-group">
          
      <a href="{{route('admin.doc.show')}}" class="list-group-item" style="border-bottom:1px solid #ffffff73!important;">Documents</a>
      ...
      <a href="{{route('admin.user',$user->id)}}" class="list-group-item @if($key==0) active @endif" style="border-bottom:1px solid #ffffff73!important;">{{$user->name}}</a>
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar py-3" style="box-shadow:none!important">
