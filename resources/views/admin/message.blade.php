...
<main class="pt-2 mx-lg-5">
    <div class="container-fluid mt-5 pt-5">
        <div class=" card p-4 text-font" style="box-shadow:none;">
            ...
            <form method="post" action="{{ route('admin.sendMessage', $id) }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    ...
                    <small id="messageHelp" class="form-text text-muted">Type your message and click on send button. Client wait for the responce.</small>
                        @error('message')
